...
public class Twain
	...
	public void Acquire()
        ...
        guif.ShowUI = Convert.ToInt16(Config.GetConfigValue("Config", "ShowScanUI"));  //ให้แสดงหน้าจอสำหรับกำหนดค่าก่อน Scan
        //guif.ShowUI = 0;
        guif.ModalUI = 1;
	...
	private static extern bool DeleteDC( IntPtr hdc );
        ...
        public static extern int GdipSaveImageToFile(IntPtr image, string filename, [In] ref Guid clsid, IntPtr encparams);
